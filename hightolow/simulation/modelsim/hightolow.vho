...
SIGNAL \ClockDivider|count[11]~DUPLICATE_q\ : std_logic;
...
SIGNAL \ClockDivider|ALT_INV_count[11]~DUPLICATE_q\ : std_logic;
...
\ClockDivider|ALT_INV_count[11]~DUPLICATE_q\ <= NOT \ClockDivider|count[11]~DUPLICATE_q\;
...
-- Equation(s):
-- \ClockDivider|Add0~37_sumout\ = SUM(( \ClockDivider|count\(0) ) + ( VCC ) + ( !VCC ))
-- \ClockDivider|Add0~38\ = CARRY(( \ClockDivider|count\(0) ) + ( VCC ) + ( !VCC ))
...
-- pragma translate_on
PORT MAP (
	datac => \ClockDivider|ALT_INV_count\(0),
	cin => GND,
...
-- Equation(s):
-- \ClockDivider|Add0~33_sumout\ = SUM(( \ClockDivider|count[1]~DUPLICATE_q\ ) + ( GND ) + ( \ClockDivider|Add0~38\ ))
-- \ClockDivider|Add0~34\ = CARRY(( \ClockDivider|count[1]~DUPLICATE_q\ ) + ( GND ) + ( \ClockDivider|Add0~38\ ))
...
-- Equation(s):
-- \ClockDivider|Add0~81_sumout\ = SUM(( \ClockDivider|count\(7) ) + ( GND ) + ( \ClockDivider|Add0~86\ ))
-- \ClockDivider|Add0~82\ = CARRY(( \ClockDivider|count\(7) ) + ( GND ) + ( \ClockDivider|Add0~86\ ))
...
-- Equation(s):
-- \ClockDivider|Add0~69_sumout\ = SUM(( \ClockDivider|count\(10) ) + ( GND ) + ( \ClockDivider|Add0~74\ ))
-- \ClockDivider|Add0~70\ = CARRY(( \ClockDivider|count\(10) ) + ( GND ) + ( \ClockDivider|Add0~74\ ))
...
-- Equation(s):
-- \ClockDivider|Add0~65_sumout\ = SUM(( \ClockDivider|count[11]~DUPLICATE_q\ ) + ( GND ) + ( \ClockDivider|Add0~70\ ))
-- \ClockDivider|Add0~66\ = CARRY(( \ClockDivider|count[11]~DUPLICATE_q\ ) + ( GND ) + ( \ClockDivider|Add0~70\ ))
...
-- Equation(s):
-- \ClockDivider|Add0~41_sumout\ = SUM(( \ClockDivider|count\(14) ) + ( GND ) + ( \ClockDivider|Add0~58\ ))
-- \ClockDivider|Add0~42\ = CARRY(( \ClockDivider|count\(14) ) + ( GND ) + ( \ClockDivider|Add0~58\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \ClockDivider|ALT_INV_count\(19),
...
-- Equation(s):
-- \ClockDivider|Add0~25_sumout\ = SUM(( \ClockDivider|count\(22) ) + ( GND ) + ( \ClockDivider|Add0~22\ ))
-- \ClockDivider|Add0~26\ = CARRY(( \ClockDivider|count\(22) ) + ( GND ) + ( \ClockDivider|Add0~22\ ))
...
-- Equation(s):
-- \ClockDivider|Equal0~1_combout\ = ( \ClockDivider|count\(22) & ( !\ClockDivider|count\(18) & ( (\ClockDivider|count\(19) & (\ClockDivider|count\(23) & (\ClockDivider|count\(21) & \ClockDivider|count\(20)))) ) ) )
...
PORT MAP (
	...
	datab => \ClockDivider|ALT_INV_count\(23),
	datac => \ClockDivider|ALT_INV_count\(21),
	datad => \ClockDivider|ALT_INV_count\(20),
	datae => \ClockDivider|ALT_INV_count\(22),
	dataf => \ClockDivider|ALT_INV_count\(18),
...
-- Equation(s):
-- \ClockDivider|Equal0~3_combout\ = ( \ClockDivider|count\(12) & ( !\ClockDivider|count\(11) & ( (!\ClockDivider|count\(8) & (!\ClockDivider|count\(9) & (\ClockDivider|count\(13) & !\ClockDivider|count\(10)))) ) ) )
...
PORT MAP (
	...
	datac => \ClockDivider|ALT_INV_count\(13),
	datad => \ClockDivider|ALT_INV_count\(10),
	datae => \ClockDivider|ALT_INV_count\(12),
	dataf => \ClockDivider|ALT_INV_count\(11),
	combout => \ClockDivider|Equal0~3_combout\);

-- Location: LABCELL_X20_Y2_N0
\ClockDivider|Equal0~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \ClockDivider|Equal0~4_combout\ = ( !\ClockDivider|count\(7) & ( \ClockDivider|count\(3) & ( (\ClockDivider|count\(6) & (\ClockDivider|count\(4) & (\ClockDivider|count\(2) & \ClockDivider|count\(5)))) ) ) )
...
PORT MAP (
	...
	datab => \ClockDivider|ALT_INV_count\(4),
	datac => \ClockDivider|ALT_INV_count\(2),
	datad => \ClockDivider|ALT_INV_count\(5),
	datae => \ClockDivider|ALT_INV_count\(7),
	dataf => \ClockDivider|ALT_INV_count\(3),
	combout => \ClockDivider|Equal0~4_combout\);

-- Location: LABCELL_X20_Y2_N12
\ClockDivider|Equal0~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \ClockDivider|Equal0~5_combout\ = ( \ClockDivider|Equal0~4_combout\ & ( (\ClockDivider|Equal0~2_combout\ & (\ClockDivider|Equal0~1_combout\ & (\ClockDivider|Equal0~0_combout\ & \ClockDivider|Equal0~3_combout\))) ) )
...
PORT MAP (
	...
	datae => \ClockDivider|ALT_INV_Equal0~4_combout\,
...
-- Equation(s):
-- \ClockDivider|Equal0~2_combout\ = ( \ClockDivider|count\(14) & ( \ClockDivider|count\(15) & ( (\ClockDivider|count\(0) & (\ClockDivider|count\(17) & (\ClockDivider|count\(1) & !\ClockDivider|count\(16)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ClockDivider|ALT_INV_count\(0),
	datab => \ClockDivider|ALT_INV_count\(17),
	datac => \ClockDivider|ALT_INV_count\(1),
	datad => \ClockDivider|ALT_INV_count\(16),
	datae => \ClockDivider|ALT_INV_count\(14),
	dataf => \ClockDivider|ALT_INV_count\(15),
	combout => \ClockDivider|Equal0~2_combout\);

-- Location: LABCELL_X20_Y2_N6
\ClockDivider|temp_clk~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \ClockDivider|temp_clk~0_combout\ = ( \ClockDivider|Equal0~4_combout\ & ( \ClockDivider|temp_clk~q\ & ( (!\ClockDivider|Equal0~2_combout\) # ((!\ClockDivider|Equal0~1_combout\) # ((!\ClockDivider|Equal0~0_combout\) # (!\ClockDivider|Equal0~3_combout\))) ) 
-- ) ) # ( !\ClockDivider|Equal0~4_combout\ & ( \ClockDivider|temp_clk~q\ ) ) # ( \ClockDivider|Equal0~4_combout\ & ( !\ClockDivider|temp_clk~q\ & ( (\ClockDivider|Equal0~2_combout\ & (\ClockDivider|Equal0~1_combout\ & (\ClockDivider|Equal0~0_combout\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \MaquinaEstados|ALT_INV_estado.S0~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \MaquinaEstados|ALT_INV_estado.S2~DUPLICATE_q\,
...
-- Equation(s):
-- \MaquinaEstados|y~0_combout\ = ( \MaquinaEstados|estado.S0~q\ & ( \MaquinaEstados|estado.S2~q\ & ( (\MaquinaEstados|y~q\) # (\reset~input_o\) ) ) ) # ( !\MaquinaEstados|estado.S0~q\ & ( \MaquinaEstados|estado.S2~q\ & ( (\MaquinaEstados|y~q\) # 
-- (\reset~input_o\) ) ) ) # ( \MaquinaEstados|estado.S0~q\ & ( !\MaquinaEstados|estado.S2~q\ & ( \MaquinaEstados|y~q\ ) ) ) # ( !\MaquinaEstados|estado.S0~q\ & ( !\MaquinaEstados|estado.S2~q\ & ( (!\reset~input_o\ & \MaquinaEstados|y~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011110000000000001111111100001111111111110000111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datac => \ALT_INV_reset~input_o\,
	datad => \MaquinaEstados|ALT_INV_y~q\,
